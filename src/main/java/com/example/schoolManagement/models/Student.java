...
public class Student {
    ...
    public String getClassLevel() { return classLevel.get(); }

    public void setClassLevel(String classLevel) { this.classLevel.set(classLevel); }
    ...
    public void setFather(String father) { this.father.set(father); }

    public int getTotalFees() { return totalFees.get(); }

    public void setTotalFees(int totalFees) { this.totalFees.set(totalFees); }

    public String isFeesStatus() { return feesStatus.get(); }

    public void setFeesStatus(String feesStatus) { this.feesStatus.set(feesStatus); }
